...
public class PropertiesLarus {
	...
	// $echo "$CATALINA_HOME"
	private final static String CATALINA_HOME = "/usr/local/tomcat/current";

	// apache webapps dir
	private final static String REAL_WEB_DIR = CATALINA_HOME + "/webapps/m3sINBioFiles/";

	// web address
	private final static String WEB_ADDRESS = "http://larus.inbio.ac.cr/m3sINBioFiles/";

	//imagenes originales,big y thumb.
	private final static String M3S_BASE_DIR = "/m3sImages/INBio/";
	...
	public static String REAL_BATCH_MEDIA_DIR = "/m3sTempImages/INBio/";
	...
	public static final int OS_FAMILY = REDHAT_FAMILY; 
