...
public class Taxon implements Serializable {
	...
	/*
	private Set<Taxon> taxonsForSubsectionTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSynonymTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForFamilyTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon>taxonsForSuperfamilyTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForStirpsTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForAncestorId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubgenusTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSpeciesTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubspeciesTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> observedTaxons = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForDominiumTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForPhylumDivisionTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSuborderTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForClassTaxonId = new HashSet<Taxon>(0);

	// private Set taxonMedias = new HashSet(0);

	private Set<Taxon> taxonsForGenusTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubphylumSubdivisionTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForOrderTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubtribeTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSectionTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> identifications = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubclassTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForKingdomTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForSubfamilyTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForTribeTaxonId = new HashSet<Taxon>(0);

	private Set<Taxon> taxonsForVarietyTaxonId = new HashSet<Taxon>(0);
	*/
	...
	public Taxon(Integer taxonId, Integer kingdomId,
			...
			Integer bimsTaxonId, String basionym, Integer countryId) {
		this.taxonId = taxonId;
	...
	public Integer getBimsTaxonId() {
		return this.bimsTaxonId;
	}

	public void setBimsTaxonId(Integer bimsTaxonId) {
		this.bimsTaxonId = bimsTaxonId;
	}
